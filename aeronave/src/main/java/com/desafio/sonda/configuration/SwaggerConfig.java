package com.desafio.sonda.configuration;
...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("com.desafio.sonda.controller"))
	...
	public static ApiInfo metadata() {
		return new ApiInfoBuilder().title("Gestão de Aeronaves - API").description("Projeto API Spring Rest - Gestão de Aeronaves")
